...
* **Defining Characteristic:** **Progressive Translation with Anchored Presentation** — emitting immediate provisional translations as acoustic tokens arrive, progressively accumulating context, and stabilizing full-clause translations with zero subtitle flicker ($\text{anchor\_displacement} = 0.0000\text{px}$).
